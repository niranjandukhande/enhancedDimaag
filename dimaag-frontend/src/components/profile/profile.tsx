...
export default function ProfilePageShowcase() {
      ...
      <AnimatePresence mode="wait">
        {
          <motion.div
            key="profile1"
            className="min-h-screen w-full bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center p-6"
